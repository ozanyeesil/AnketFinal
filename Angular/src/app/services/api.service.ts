...
export class ApiService {
  ...
  Cevap1Liste(s: number) {
    return this.http.get(this.apiUrl + "/cevap1/" + s);
  }
  Cevap2Liste(s: number) {
    return this.http.get(this.apiUrl + "/cevap2/" + s);
  }
  Cevap3Liste(s: number) {
    return this.http.get(this.apiUrl + "/cevap3/" + s);
  }
